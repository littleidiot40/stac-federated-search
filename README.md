...
| `describedby` | any | any | [OACommon](http://docs.opengeospatial.org/DRAFTS/20-024.html) | Additional information about the structure or semantics of the collection as per [§8.2.4 of OGC API-Common - Part 2](http://docs.opengeospatial.org/DRAFTS/20-024.html#_links). |
